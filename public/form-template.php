                ...
                <div class="sola-payment-methods">
                    ...
                    <div class="sola-wallet-buttons">
                        <button type="button" class="sola-wallet-btn google-pay" title="Requires merchant verification">
                            <svg class="google-pay-logo" width="60" height="24" viewBox="0 -209.5 512 512" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                                <g>
                        ...
                        <button type="button" class="sola-wallet-btn apple-pay" title="Requires merchant verification">
                            <svg class="apple-pay-logo" width="60" height="24" viewBox="0 -150.5 512 512" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                                <g>
